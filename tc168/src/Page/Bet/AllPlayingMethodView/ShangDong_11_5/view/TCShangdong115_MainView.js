...
export default class TCMarkSix_MainView extends React.Component {
    ...
    renderNumberView() {
        ...
        switch (this.state.type) {
            ...
            case '任选七':
            case '任选八': {
                itemArray.push(<TCShangDong115NumberSelectView titleName='选号' key={1} areaIndex={0} ref="ref1" numberArray={SingletonDPS.config.getNumbersArray()}/>)
            }
                break
            case '前一直选': {
                itemArray.push(<TCShangDong115NumberSelectView titleName='万位' key={1} areaIndex={0} ref="ref1" numberArray={SingletonDPS.config.getNumbersArray()}/>)
            }
                break
            case '前二组选': {
                itemArray.push(<TCShangDong115NumberSelectView titleName='选号' key={1} areaIndex={0} ref="ref1" numberArray={SingletonDPS.config.getNumbersArray()}/>)
            ...
            case '前二直选': {
                itemArray.push(<TCShangDong115NumberSelectView titleName='万位' key={1} areaIndex={0} ref="ref1" numberArray={SingletonDPS.config.getNumbersArray()}/>)
                itemArray.push(<TCShangDong115NumberSelectView titleName='千位' key={2} areaIndex={1} ref="ref2" numberArray={SingletonDPS.config.getNumbersArray()}/>)
            }
                break
            case '前三组选': {
                itemArray.push(<TCShangDong115NumberSelectView titleName='选号' key={1} areaIndex={0} ref="ref1" numberArray={SingletonDPS.config.getNumbersArray()}/>)
            ...
            case '前三直选': {
                itemArray.push(<TCShangDong115NumberSelectView titleName='万位' key={1} areaIndex={0} ref="ref1" numberArray={SingletonDPS.config.getNumbersArray()}/>)
                itemArray.push(<TCShangDong115NumberSelectView titleName='千位' key={2} areaIndex={1} ref="ref2" numberArray={SingletonDPS.config.getNumbersArray()}/>)
                itemArray.push(<TCShangDong115NumberSelectView titleName='百位' key={3} areaIndex={2} ref="ref3" numberArray={SingletonDPS.config.getNumbersArray()}/>)
            }
                break
            case '前二组选胆拖': {
    ...
    getDuplexItemArray(itemArray, duplexMaxCount) {
        itemArray.push(<TCShangDong115DuplexSelectView numberAddEvent={(e, p)=>this._numberButtonCall(e, p)}
                                                       titleName='胆码' maxSelectNumbers={duplexMaxCount} key={1} areaIndex={0} ref="ref1"
                                                       numberArray={SingletonDPS.config.getNumbersArray()}/>)

        itemArray.push(<TCShangDong115DuplexSelectView numberAddEvent={(e, p)=>this._numberButtonCall(e, p)}
                                                       titleName='拖码' maxSelectNumbers={duplexMaxCount} key={2} areaIndex={1} ref="ref2"
                                                       numberArray={SingletonDPS.config.getNumbersArray()}/>)
    }
    ...
    _numberButtonCall(number, areaIndex) {
        ...
        let alreadyAddNumberCount = SingletonDPS.getAreaNumbersCount(0)
