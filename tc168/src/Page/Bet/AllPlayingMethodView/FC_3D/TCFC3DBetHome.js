...
import TCFC3D_MainView from './view/TCFC3D_MainView'
...
export default class TCMarkSixBetHome extends React.Component {
    ...
    componentDidMount() {
        ...
        this.listener = RCTDeviceEventEmitter.addListener('FC3DNumberCall', (areaIndex, number, isAdd) => {
            if (isAdd) {
    ...
    //初始化玩法号码选择
    initialContentView() {
        return <TCFC3D_MainView ref='TCFC3D_MainView' shakeEvent={()=>this.byShake()}/>
    }
    ...
    choosePlayType(index, areaIndex) {
        ...
        let contentView = this.refs.TCFC3D_MainView
    ...
    clearSelectedNumbers() {
        ...
        RCTDeviceEventEmitter.emit('FC3DNumberCall_clear');
        let bottomView = this.refs.TCBetHomeBottomView
