...
import ShangDong115_DPS from './data/TCBJPK10_DPS'
...
export default class TCMarkSixBetHome extends React.Component {
    ...
    componentDidMount() {
        ...
        this.listener = RCTDeviceEventEmitter.addListener('BJPK10NumberCall', (areaIndex, number, isAdd) => {
            if (isAdd) {
    ...
    //初始化玩法号码选择
    initialContentView() {
        return <TCBJPK10_MainView ref='TCBJPK10_MainView' shakeEvent={()=>this.byShake()}/>
    }
