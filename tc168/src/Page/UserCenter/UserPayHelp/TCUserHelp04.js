        ...
        return (
            ...
            >
                <View style={styles.modalStyle}>
                    <Image source={!this.props.isWeChat?require('image!alipay04'):require('image!wechat04')} style={styles.imgViewStyle} resizeMode={'contain'}/>

                    <View style={styles.btmBtnViewStyle}>

                        <TouchableOpacity onPress={()=>this.props.next()}><Text
                            style={styles.btmBtnTxtStyle}>完成</Text></TouchableOpacity>
                    </View>
                </View>
            </Modal>
        )
